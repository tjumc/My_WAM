...
export DIFFSYNTH_MODEL_BASE_PATH="/data/share/1919650160032350208/foundation_model/FastWAM/checkpoints"
export ACTION_DIT_PRETRAINED_PATH="/data/share/1919650160032350208/machong14/ckpt/wam/actiondit/ActionDiT_linear_interp_Wan22_alphascale_1024hdim.pt"
...
# =========================
source configs/data/PPU_astribot_dataset_catalog.sh
