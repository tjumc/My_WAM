#!/usr/bin/env python3
"""V3.4.8 signal-grounded refinement with pass1-anchor protection."""
import argparse
import json
...
def main():
    ...
    def resolve_pair(a, b):
        ...
        # A non-anchor phase may not take frames from the semantic core of a
        # validated pass1 phase. Keep its complete provisional boundary when
        # feasible; otherwise the anchor still receives duration priority.
