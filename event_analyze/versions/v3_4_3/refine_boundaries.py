#!/usr/bin/env python3
"""V3.4.3 signal-grounded boundary refinement for deterministic skills."""
import argparse
import json
...
def main():
    ...
    #
    # V3.4.3 treats the upstream provisional interval as a semantic ownership
    ...
    result = {
        ...
        "notes": [
            "V3.4.3 phases use interaction-validated trajectory-level entity-state-machine skills, not LLM-generated phases.",
