#!/usr/bin/env python3
"""V3.4.9 state-implication-aware final task-graph decoder.
...
def main():
    ...
    ann.setdefault("notes", []).append(
        "V3.4.9 additionally rehabilitates only directly evidenced rejected candidates and preserves validated pass1 anchors during boundary arbitration; missing actions are never fabricated."
    )
