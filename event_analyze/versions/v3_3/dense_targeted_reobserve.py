#!/usr/bin/env python3
"""V3.3 dense targeted temporal observation for small/occluded articulated entities.
...
def main():
    ...
    for w in windows:
        ...
        if obj["confidence"] >= args.min_merge_confidence and (
            directional or (
                obj["relative_motion"] == "stationary"
                and obj["start_state"] in {"in", "out"}
                and obj["end_state"] == obj["start_state"]
            )
        ):
