#!/usr/bin/env python3
"""Compact a completed V3.4.5 runtime directory.

Default completed layout:
  hierarchical_annotations.json
  evaluation_temporal.json (optional)
  diagnostics/
  cache/

KEEP_DEBUG=1 skips destructive cleanup.
"""
import argparse
import os
import shutil
...
def main():
    ...
    if keep_debug:
        print("KEEP_DEBUG=1: preserving full V3.4.5 runtime artifacts")
        return
