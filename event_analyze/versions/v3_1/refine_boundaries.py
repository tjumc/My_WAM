#!/usr/bin/env python3
"""V3.1 signal-grounded boundary refinement for deterministic skills."""
import argparse
import json
...
def main():
    ...
    candidates = json.load(open(out / "skill_candidates.json", encoding="utf-8"))
    ...
    result = {
        ...
        "notes": [
            "V3.1 phases come from trajectory-level tracked entity-state-machine skills, not LLM-generated phases.",
